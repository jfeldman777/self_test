...
const interactionGameData = {
    ...
    elements: [
        ...
        { id: 4, content: 'изоляция' }, { id: 5, content: 'как вещь' }, { id: 6, content: 'как вещь' },
        { id: 7, content: '2' }, { id: 8, content: 'семья' }, { id: 9, content: 'свои' },
        { id: 10, content: 'чужие' }, { id: 11, content: 'как одна из вещей' }, { id: 12, content: 'как одна из вещей' },
        { id: 13, content: '3' }, { id: 14, content: 'борьба' }, { id: 15, content: 'доминирование' },
        { id: 16, content: 'подчинение' }, { id: 17, content: 'как средство' }, { id: 18, content: 'как помеха' },
        { id: 19, content: '4' }, { id: 20, content: 'правила' }, { id: 21, content: 'координация' },
        { id: 22, content: 'взаимозависимость' }, { id: 23, content: 'как партнер' }, { id: 24, content: 'как роль в ролевой системе' },
        { id: 25, content: '5' }, { id: 26, content: 'импровизация' }, { id: 27, content: 'свобода' },
        { id: 28, content: 'непредсказуемость' }, { id: 29, content: 'конкурент' }, { id: 30, content: 'как фактор неопределенности' },
        { id: 31, content: '6' }, { id: 32, content: 'диалог' }, { id: 33, content: 'обоснование' },
        { id: 34, content: 'опровержение' }, { id: 35, content: 'собеседник' }, { id: 36, content: 'коллега' },
        { id: 37, content: '7' }, { id: 38, content: 'оригинальность подхода' }, { id: 39, content: 'новаторство' },
        { id: 40, content: 'разрушение традиции' }, { id: 41, content: 'мыслитель' }, { id: 42, content: 'мыслящее существо' },
        { id: 43, content: '8' }, { id: 44, content: 'моделирование чужого сознания' }, { id: 45, content: 'Мультиверсум' },
        { id: 46, content: 'Абсолютная эмпатия' }, { id: 47, content: 'Другая вселенная' }, { id: 48, content: 'Другая вселенная' }
    ]
};
